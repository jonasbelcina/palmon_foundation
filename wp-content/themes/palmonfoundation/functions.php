...
function pf_scripts() {
	...
	wp_register_style('pf-bootstrap', get_template_directory_uri().'/assets/vendor/bootstrap' . $suffix . '.css', array(), '3.3.6' );
...
require get_template_directory() . '/plugins/acf-image-crop/acf-image-crop.php';
...
add_action( 'init', 'pf_programs_init' );

// Create Events Custom Post Type
function pf_events_init() {
    $args = array(
      	'labels' => array(
...
add_action( 'init', 'pf_events_init' );

// Create Voices of Change Custom Post Type
...
register_nav_menus( array(
    'primary' => __( 'Primary Menu', 'palmonfoundation' ),
) );
